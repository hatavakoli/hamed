...
/** Small "?" next to a technical term. Used all over the dashboard. */
function InfoHint({ children, className }: { children: React.ReactNode; className?: string }) {
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        <button type="button" className={cn('inline-flex text-muted-foreground hover:text-foreground', className)} aria-label="More information">
